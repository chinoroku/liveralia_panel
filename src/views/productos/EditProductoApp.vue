                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10 col-xl-8">
                                ...
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <ul class="nav nav-tabs nav-overflow header-tabs">
                                            <li class="nav-item">
                                                <router-link class="nav-link" to="/producto">Todos los
                        ...
                        <div class="mb-7">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="" class="form-select" v-model="producto.subcategoria">
                                            <option value="" disabled selected>Seleccionar</option>
                                            <option :value="item.titulo" v-for="item in subcategorias">{{ item.titulo }}
                                            </option>
                                        </select>
                            ...
                            <!-- Button -->
                            <button class="btn btn-primary mt-3" v-on:click="validar()">
                                Actualizar producto
                            </button>
                            ...
                            <div class="row justify-content-between align-items-center mb-4">
                                <div class="col-12">
                                    ...
                                    <p class="text-muted mb-xl-0">
                                        Ingreso de la variades de un producto con su proveedor respectivo.
                                    </p>
                                </div>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-5">
                                        ...
                                        <select name="" class="form-select" v-model="variedad.proveedor">
                                            <option value="" disabled selected>Seleccionar</option>
