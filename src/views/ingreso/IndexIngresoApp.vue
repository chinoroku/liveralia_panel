                                ...
                                <table class="table table-sm table-nowrap card-table">
                                    ...
                                    <tbody class="fs-base" v-if="ingresos.length >= 1">
                                        <tr v-for="item in ingresos">
                                            ...
                                            <td>
                                                <a>{{ convertCurrency(item.monto_resultante) }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-sm"><router-link
                                                        style="color: #ffffff !important;"
                                                        :to="{ name: 'ingreso-detalle', params: { id: item._id } }">Ver
                                                        detalles</router-link></button>
